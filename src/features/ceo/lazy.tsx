...
// features/leads/lazy.tsx). As duas abas construídas — Financeiro e Projeções — plotam séries,
// e o Radix Tabs só monta uma por vez: sem isto, abrir `?aba=projecoes` baixava também todo o
// código do Financeiro, e vice-versa.
